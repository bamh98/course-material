...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/@vuepress/bundler-webpack/lib/build/ssr/vuepressLoader.js!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[1]!./src/.vuepress/.temp/pages/lectures/android-coordinator-layout/index.html.vue?vue&type=template&id=f3674fba
        ...
        _push((0,server_renderer.ssrRenderComponent)(_component_CodeGroupItem, { title: "Result" }, {
          default: (0,external_vue_.withCtx)((_, _push, _parent, _scopeId) => {
            if (_push) {
              ...
              return [
                (0,external_vue_.createVNode)(_component_Smartphone, null, {
...
<span class="token punctuation"${
        ...
        _push((0,server_renderer.ssrRenderComponent)(_component_CodeGroupItem, { title: "activity_layout.xml" }, {
          default: (0,external_vue_.withCtx)((_, _push, _parent, _scopeId) => {
            if (_push) {
...
<span class="token tag"${
        ...
        return [
          (0,external_vue_.createVNode)(_component_CodeGroupItem, { title: "Result" }, {
            default: (0,external_vue_.withCtx)(() => [
              (0,external_vue_.createVNode)(_component_Smartphone, null, {
                default: (0,external_vue_.withCtx)(() => [
                  (0,external_vue_.createVNode)("div", null, "Some text"),
          ...
          (0,external_vue_.createVNode)(_component_CodeGroupItem, { title: "activity_layout.xml" }, {
            default: (0,external_vue_.withCtx)(() => [
              (0,external_vue_.createVNode)("div", { class: "language-xml ext-xml line-numbers-mode" }, [
                (0,external_vue_.createVNode)("pre", { class: "language-xml" }, [
                  (0,external_vue_.createVNode)("code", null, [
  ...
  _push(`<p>If we want the second <code>TextView</code> to be moved the same way as the first <code>TextView</code>, we can add a <code>Behavior</code> to it that tells the <code>CoordinatorLayout</code> that it depends on the first <code>TextView</code>. Then the <code>CoordinatorLayout</code> will notify the <code>Behavior</code> each time the first <code>TextView</code> is moved, and the <code>Behavior</code> can in turn change the position of the second <code>TextView</code> it has been added to, as in the <code>Activity</code> below.</p>`)
  _push((0,server_renderer.ssrRenderComponent)(_component_CodeGroup, null, {
    default: (0,external_vue_.withCtx)((_, _push, _parent, _scopeId) => {
      if (_push) {
        _push((0,server_renderer.ssrRenderComponent)(_component_CodeGroupItem, { title: "Result" }, {
  ...
  <span class="token attr-name"${
    ...
    <span class="token tag"${
      ...
      <span class="token attr-name"${
                ...
                _scopeId
              }>&lt;!-- Only change from before: Behavior added! --&gt;</span>
                ...
                (0,external_vue_.createVNode)("div", { class: "language-xml ext-xml line-numbers-mode" }, [
                  (0,external_vue_.createVNode)("pre", { class: "language-xml" }, [
                    (0,external_vue_.createVNode)("code", null, [
                      ...
                      (0,external_vue_.createTextVNode)(),
                      (0,external_vue_.createVNode)("span", { class: "token comment" }, "<!-- Only change from before: Behavior added! -->"),
                      (0,external_vue_.createTextVNode)("\n\n    "),
                      (0,external_vue_.createVNode)("span", { class: "token tag" }, [
                        (0,external_vue_.createVNode)("span", { class: "token tag" }, [
                          (0,external_vue_.createVNode)("span", { class: "token punctuation" }, "<"),
...
<span class="token comment"${
                _scopeId
              }>// not dependent on any TextView specific functionality (it would work equally well on a Button)</span>
<span class="token keyword"${
                _scopeId
  ...
  <span class="token punctuation"${
    ...
    <span class="token comment"${
                _scopeId
              }>// Return true to tell the CoordinatorLayout that you have changed this view.</span>
    <span class="token keyword"${
                _scopeId
                ...
                (0,external_vue_.createVNode)("div", { class: "language-kotlin ext-kt line-numbers-mode" }, [
                  (0,external_vue_.createVNode)("pre", { class: "language-kotlin" }, [
                    (0,external_vue_.createVNode)("code", null, [
                      ...
                      (0,external_vue_.createTextVNode)("\n"),
                      (0,external_vue_.createVNode)("span", { class: "token comment" }, "// not dependent on any TextView specific functionality (it would work equally well on a Button)"),
                      (0,external_vue_.createTextVNode)("\n"),
                      (0,external_vue_.createVNode)("span", { class: "token keyword" }, "class"),
                      (0,external_vue_.createTextVNode)(),
                      ...
                      (0,external_vue_.createVNode)("span", { class: "token punctuation" }, ")"),
                      (0,external_vue_.createTextVNode)("\n    \n    "),
                      (0,external_vue_.createVNode)("span", { class: "token comment" }, "// Return true to tell the CoordinatorLayout that you have changed this view."),
                      (0,external_vue_.createTextVNode)("\n    "),
...
;// CONCATENATED MODULE: ./src/.vuepress/.temp/pages/lectures/android-coordinator-layout/index.html.vue?vue&type=template&id=f3674fba
