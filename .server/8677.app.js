...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/@vuepress/bundler-webpack/lib/build/ssr/vuepressLoader.js!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[1]!./src/.vuepress/.temp/pages/lectures/android-fragments/index.html.vue?vue&type=template&id=77978bbe
...
function ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push((0,server_renderer.ssrRenderComponent)(_component_OutboundLink, null, null, _parent))
  _push(`</a>.</li><li>In the course book Elements of Android Jetpack: <ul><li><a href="https://wares.commonsware.com/app/internal/book/Jetpack/page/chap-fragments-001.html" target="_blank" rel="noopener noreferrer">Adopting Fragments`)
  _push((0,server_renderer.ssrRenderComponent)(_component_OutboundLink, null, null, _parent))
  _push(`</a></li></ul></li></ul><h2 id="examples" tabindex="-1"><a class="header-anchor" href="#examples" aria-hidden="true">#</a> Examples</h2><h3 id="static-counter-fragment" tabindex="-1"><a class="header-anchor" href="#static-counter-fragment" aria-hidden="true">#</a> Static counter fragment</h3><p>The <code>CounterFragment</code> contains a counter button starting on 0. Its state is retained across runtime configuration changes. Three instances of it are statically inserted into the <code>MainActivity</code> using the <code>&lt;fragment&gt;</code> tag.</p>`)
...
<span class="token tag"${
  ...
  _push(`<h3 id="dynamic-countdown-fragment" tabindex="-1"><a class="header-anchor" href="#dynamic-countdown-fragment" aria-hidden="true">#</a> Dynamic countdown fragment</h3><p>The <code>CounterFragment</code> functions as a countdown. The start value is configurable and retained across runtime configuration changes using the arguments Bundle. Its state is retained across runtime configuration changes using the savedInstanceState Bundle. Three instances of it are dynamically inserted into the <code>MainActivity</code>.</p>`)
  _push((0,server_renderer.ssrRenderComponent)(_component_CodeGroup, null, {
    default: (0,external_vue_.withCtx)((_, _push, _parent, _scopeId) => {
      if (_push) {
        _push((0,server_renderer.ssrRenderComponent)(_component_CodeGroupItem, { title: "MainActivity.kt" }, {
...
;// CONCATENATED MODULE: ./src/.vuepress/.temp/pages/lectures/android-fragments/index.html.vue?vue&type=template&id=77978bbe
