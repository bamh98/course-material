...
function ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<!--[--><h1 id="lectures" tabindex="-1"><a class="header-anchor" href="#lectures" aria-hidden="true">#</a> Lectures</h1><p>The instructions on the `)
  ...
  _push(` page indicate when you&#39;re expected to view each lecture, but here&#39;s a list of all of them.</p><ul><li>`)
  ...
  _push((0,server_renderer.ssrRenderComponent)(_component_RouterLink, { to: "/lectures/rest-api-authorization/" }, {
    default: (0,external_vue_.withCtx)((_, _push, _parent, _scopeId) => {
      if (_push) {
        _push(`(will be updated) REST API Authorization`)
      } else {
        return [
          (0,external_vue_.createTextVNode)("(will be updated) REST API Authorization")
        ]
      }
    }),
    _: 1
  ...
  _push((0,server_renderer.ssrRenderComponent)(_component_RouterLink, { to: "/lectures/sop-and-cors/" }, {
    default: (0,external_vue_.withCtx)((_, _push, _parent, _scopeId) => {
      if (_push) {
        _push(`Same-Origin Policy &amp; Cross-Origin Resource Sharing`)
      } else {
        return [
          (0,external_vue_.createTextVNode)("Same-Origin Policy & Cross-Origin Resource Sharing")
        ]
      }
    }),
    _: 1
...
;// CONCATENATED MODULE: ./src/.vuepress/.temp/pages/courses/web-development-advanced-concepts/lectures.html.vue?vue&type=template&id=739330aa

// EXTERNAL MODULE: ./node_modules/vue-loader/dist/exportHelper.js
var exportHelper = __webpack_require__(3744);
;// CONCATENATED MODULE: ./src/.vuepress/.temp/pages/courses/web-development-advanced-concepts/lectures.html.vue
...
/* harmony default export */ const lectures_html = (__exports__);
...
const data = {
  ...
  "excerpt": "",
  "headers": [],
  "filePathRelative": "courses/web-development-advanced-concepts/lectures.md",
  "git": {
...
;
//# sourceMappingURL=7423.app.js.map